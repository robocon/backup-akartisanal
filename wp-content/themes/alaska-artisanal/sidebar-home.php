...
?>  
    ...
    <div id="widgets" class="home-widgets">
        ...
        <?php responsive_widgets(); // above widgets hook ?>
            ...
            <div class="widget-wrapper" id="wideget-mid">
        ...
        <?php responsive_widgets(); // responsive above widgets hook ?>
            ...
            <div class="widget-wrapper">
                ...
                <div class="widget-title-home"><h3><a href="#" data-reveal-id="newsletter-signup"><?php _e('Home Widget 2', 'responsive'); ?></a></h3></div>
        ...
        <?php responsive_widgets(); // above widgets hook ?>
            ...
            <div class="widget-wrapper" id="widget-dark">
